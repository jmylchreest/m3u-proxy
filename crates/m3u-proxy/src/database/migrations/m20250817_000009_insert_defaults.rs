//! Migration to insert default data for SeaORM
//!
...
impl Migration {
    ...
    fn create_timestamp_value(manager: &SchemaManager<'_>, timestamp: &chrono::DateTime<chrono::Utc>) -> SimpleExpr {
        match manager.get_database_backend() {
            sea_orm::DatabaseBackend::Postgres => {
    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let default_relay_profiles = vec![
            ...
            ("a9b8c7d6-e5f4-3210-9876-543210987654",
             ...
             "h264", "aac", Some("main"), Some("fast"),
             Some(2000), Some(128), Some(48000), Some(2),
             true, Some("auto"),
             "transport_stream", None::<i32>, None::<i32>, 30,
             true, true),
            ...
            ("b8c7d6e5-f4a3-2109-8765-432109876543",
             ...
             "h265", "aac", Some("main"), Some("fast"),
             Some(1500), Some(128), Some(48000), Some(2),
             true, Some("auto"),
             "transport_stream", None::<i32>, None::<i32>, 30,
             true, true),
            ...
            ("c7d6e5f4-a3b2-1098-7654-321098765432",
             ...
             "h264", "aac", Some("high"), Some("slower"),
             Some(4000), Some(192), Some(48000), Some(2),
             true, Some("auto"),
             "transport_stream", None::<i32>, None::<i32>, 30,
             false, true),
            ...
            ("d6e5f4c3-b2a1-0987-6543-210987654321",
             ...
             "h264", "aac", Some("baseline"), Some("veryfast"),
             Some(800), Some(96), Some(48000), Some(2),
             true, Some("auto"),
             "transport_stream", None::<i32>, None::<i32>, 30,
             false, true),
            ...
            ("e5f4c3b2-a109-8765-4321-098765432109",
             ...
             "h265", "aac", Some("main"), Some("slow"),
             Some(3000), Some(192), Some(48000), Some(2),
             true, Some("auto"),
             "transport_stream", None::<i32>, None::<i32>, 30,
             false, true),
            ...
            ("f4c3b2a1-0987-6543-2109-876543210987",
             ...
             "av1", "aac", None, Some("medium"),
             Some(2500), Some(128), Some(48000), Some(2),
             true, Some("auto"),
             "transport_stream", None::<i32>, None::<i32>, 30,
             false, true),
        ...
        for (id, name, description, video_codec, audio_codec, video_profile, video_preset,
             video_bitrate, audio_bitrate, audio_sample_rate, audio_channels,
             enable_hw_accel, preferred_hwaccel,
             output_format, segment_duration, max_segments, input_timeout,
             is_system_default, is_active) in default_relay_profiles {
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.exec_stmt(
            Query::delete()
                ...
                .and_where(Expr::col(DataMappingRules::Id).eq(Self::create_uuid_value(manager, "7f4a2e5c-1b3d-4a7e-9f8b-2c5e7a9d1f3b")))
                .to_owned()
        ).await?;
