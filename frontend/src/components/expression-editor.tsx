...
function createErrorHighlights(errors: ExpressionValidationError[], expression: string): ErrorHighlight[] {
    ...
    <TooltipProvider>
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {(() => {
          ...
          const groupedMeasurements = new Map<string, typeof measurements[0] & { errors: ExpressionValidationError[] }>()
              ...
              <TooltipTrigger asChild>
                <div
                  ...
                  style={{
                    ...
                    width: group.width,
                    height: group.height,
                    background: 'repeating-linear-gradient(45deg, transparent, transparent 2px, #ef4444 2px, #ef4444 4px)',
                ...
                <div className="space-y-3">
                  {group.errors.map((error, errorIndex) => (
                    <div key={errorIndex} className="space-y-1">
                      ...
                      {errorIndex < group.errors.length - 1 && (
