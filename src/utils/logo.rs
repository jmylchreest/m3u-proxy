...
impl LogoUrlGenerator {
    ...
    /// // Result: "https://api.example.com/api/logos/{uuid}/formats/thumbnail?size=small"
    /// ```
    pub fn generate(logo_id: Uuid, config: LogoUrlConfig) -> String {
        // Build the path component
        let path = match config.format {
            Some(format) => format!("/api/logos/{}/formats/{}", logo_id, format),
            None => format!("/api/logos/{}", logo_id),
        };
    ...
    /// # Returns
    ///
    /// Relative URL string (e.g., "/api/logos/{uuid}")
    ///
    /// # Examples
    ///
    /// ```rust
    /// let url = LogoUrlGenerator::relative(logo_id);
    /// // Result: "/api/logos/12345678-1234-5678-9abc-123456789abc"
    /// ```
    ...
    /// // Result: "https://api.example.com/api/logos/12345678-1234-5678-9abc-123456789abc"
    /// ```
...
mod tests {
    ...
    fn test_relative_url() {
        ...
        assert_eq!(url, "/api/logos/12345678-1234-5678-9abc-123456789abc");
    }
    ...
    fn test_full_url() {
        ...
        assert_eq!(
            url,
            "https://api.example.com/api/logos/12345678-1234-5678-9abc-123456789abc"
        );
    }
    ...
    fn test_url_with_format() {
        ...
        assert_eq!(
            url,
            "/api/logos/12345678-1234-5678-9abc-123456789abc/formats/thumbnail"
        );
    }
    ...
    fn test_full_url_with_format() {
        ...
        assert_eq!(
            url,
            "https://api.example.com/api/logos/12345678-1234-5678-9abc-123456789abc/formats/thumbnail"
        );
    }
    ...
    fn test_builder() {
        ...
        assert!(url.starts_with("https://api.example.com/api/logos/"));
