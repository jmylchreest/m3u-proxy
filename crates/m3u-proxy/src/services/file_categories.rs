...
mod tests {
    ...
    fn test_file_extension_removal() {
        ...
        assert_eq!(remove_file_extension("domain.com/file.png"), "domain.com/file");
        assert_eq!(remove_file_extension("domain.com/path"), "domain.com/path"); // No extension
        
        // Don't remove dots from domain names
        assert_eq!(remove_file_extension("sub.domain.com/path"), "sub.domain.com/path");
        
        // Very long "extensions" should not be removed
        assert_eq!(remove_file_extension("/file.verylongextension"), "/file.verylongextension");
    }
    ...
    fn test_logo_cache_id_generation() {
        ...
        assert_eq!(generate_logo_cache_id(url_params1), generate_logo_cache_id(url_params2));
    }
}