...
export function getOperatorBadgeClasses(operator: string | undefined | null): string {
  ...
  switch (normalizedOp) {
    ...
    case 'equals':
      return statusColors.success.bg + ' ' + statusColors.success.text + ' ' + statusColors.success.border + ' border'
    case 'not_equals':
      return statusColors.warning.bg + ' ' + statusColors.warning.text + ' ' + statusColors.warning.border + ' border'
    case 'regex':
    ...
    case 'not_in':
      return statusColors.error.bg + ' ' + statusColors.error.text + ' ' + statusColors.error.border + ' border'
    default:
      return statusColors.neutral.bg + ' ' + statusColors.neutral.text + ' ' + statusColors.neutral.border + ' border'
  }
}