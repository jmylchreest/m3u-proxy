...
impl ConnectionLimiter {
    ...
    pub async fn register_connection(
        ...
        proxy_id: &str,
        channel_id: &str,
    ) -> Result<ConnectionHandle, LimitExceededError> {
        // Check limits first
        ...
        debug!(
            "Registered connection - proxy {}: {}, channel {}: {}",
...
impl Drop for ConnectionHandle {
    fn drop(&mut self) {
        ...
        tokio::spawn(async move {
            ...
            debug!(
                "Released connection - proxy: {}, channel: {}",
                proxy_id, channel_id
            );
        });
    }
...
mod tests {
    ...
    async fn test_connection_limits() {
        ...
        let _handle1 = limiter
            .register_connection("proxy1", "channel1")
            .await
            .unwrap();
        ...
        assert!(matches!(
            result,
            Err(LimitExceededError::ChannelClientLimit { .. })
        ));
